...
pdf(paste(CLASS,classLabelsTag,"nulls_kDN.pdf",sep="_"),w=16,h=10)
...
pdf(paste(CLASS,classLabelsTag,"distribution_kDN.pdf",sep="_"),w=16,h=10)
...
# # Second output 
# pdf(paste0(CLASS,"_sub_group_kDN.pdf"),w=24,h=16)
...
write.csv(combined_means,file=paste(CLASS,classLabelsTag,"mean_kDN.csv",sep="_"),row.names=F)
write.csv(all_classes_kDN,file=paste(CLASS,classLabelsTag,"by_gi_kDN.csv",sep="_"),row.names=F)
