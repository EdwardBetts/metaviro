# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 17:04:23 2013
...
#            print contig_info[0]
#            print numpy.mean(freq_vectors[0]),numpy.mean(freq_vectors[1])
#            print numpy.std(freq_vectors[0]),numpy.std(freq_vectors[1])
#            print min(freq_vectors[0]),min(freq_vectors[1])
#            print max(freq_vectors[0]),max(freq_vectors[1])
...
#                    sys.stderr.write( str(query_vector[i]) + ' ' + str(i) + "\n")
            ...
            self.result_queue.put((contig_info[0], kldiv))
...
if __name__ == '__main__':
    ...
    for ref_prefix in ref_prefixes:    
        ...
        for contig in query_contigs:
            work_queue.put((contig, query_contigs[contig], ref_vector, ref_prefix))
    ...
    with open('%s.kl' % query_prefix, 'w') as outfh:
